...
- Generating scripts in readonly-folder may fail due to file-level permission issues. It is recommended to use a local folder for script generation to avoid such problems.
